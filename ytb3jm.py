...
def main():
    ...
    # ✅ Naikkan limit upload file ke 30 GB → bisa video 3 jam lebih
    st.config.set_option("server.maxUploadSize", 30000)
    ...
    # ✅ Upload file video (mp4/flv) – bisa sampai 30 GB
    ...
    if uploaded_file:
        ...
        with open(video_path, "wb") as f:
            # tulis chunked agar aman utk file > RAM
